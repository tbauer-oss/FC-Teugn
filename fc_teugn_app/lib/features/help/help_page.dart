...
const helpArticles = <HelpArticle>[
  ...
  HelpArticle(
    ...
    summary:
        'Eltern bieten Fahrten an oder buchen direkt für sich und ihre Kinder; Trainer behalten den Überblick.',
    keywords: ['Fahrt', 'Mitfahrplatz', 'Auto', 'Fahrgemeinschaft'],
    route: '/events',
    routeLabel: 'Kalender öffnen',
    steps: [
      'Öffne beim nächsten Spiel auf der Startseite die Mitfahrten oder im Termin den Bereich „Fahrgemeinschaften“.',
      'Wähle „Anbieten“ für eine eigene Fahrt oder „Mitfahren“ für deinen Bedarf. Du kannst dich selbst und deine Kinder gemeinsam auswählen.',
      'Über „Hier eintragen“ buchst du direkt in einer angebotenen Fahrt. Jede Person belegt einen Platz: Aus fünf freien Plätzen werden bei einer Buchung vier.',
      'Offener Bedarf wird automatisch zugeordnet, sobald eine passende Fahrt genügend Plätze für die gemeinsam ausgewählten Personen hat. Ungedeckter Bedarf erscheint rot für die Mannschaft. Bei einer Stornierung werden Plätze frei und wartende Personen können nachrücken.',
  ...
  HelpArticle(
    ...
    steps: [
      ...
      'Mit dem Haus-Symbol gelangst du jederzeit zur SpielPLUS-Startseite. Die Android-Zurück-Taste navigiert zunächst innerhalb von SpielPLUS; der Pfeil im App-Kopf führt zurück zur FC-Teugn-App.',
  ...
  HelpArticle(
    ...
    steps: [
      ...
      'Im Wechselplan steht unter jedem eingewechselten Spieler ausdrücklich die Zielposition, zum Beispiel „auf RM“.',
  ...
  HelpArticle(
    ...
    steps: [
      ...
      'Unter „Statistiken“ zeigt das trainerinterne Leistungszentrum Trainer- und anonyme Elternwerte nebeneinander, Filter sowie die Entwicklungskurve mit Zeitleiste.',
  ...
  HelpArticle(
    ...
    steps: [
      ...
      'Nach Abpfiff können Eltern im Reiter „Bewertung“ freiwillig von 1 bis 10 bewerten. Angezeigt wird dem Trainerteam nur der anonyme Gesamtwert, niemals die Bewertung eines einzelnen Elternkontos.',
      'Trainerbewertungen, Eltern-Durchschnitt, Entwicklungskurven und taktische Notizen bleiben ausschließlich für das Trainerteam sichtbar.',
    ],
  ),
  HelpArticle(
    category: HelpCategory.training,
  ...
  HelpArticle(
    ...
    steps: [
      ...
      'Trainer sehen zusätzlich das Leistungszentrum mit Trainer- und anonymen Elternbewertungen von 1 bis 10, Filtern, Saisonmittel und detaillierter Entwicklungszeitleiste.',

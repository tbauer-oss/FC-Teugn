...
const _catalog = <RolePermission>[
  ...
  RolePermission(
    'CONFIGURE_TRAINING_REMINDERS',
    'Trainingserinnerungen konfigurieren',
    PermissionKind.edit,
  ),
  RolePermission(
    'CANCEL_TRAINING_OCCURRENCE',
    'Einzelnes Training absagen',
    PermissionKind.edit,
  ),
  RolePermission(
    'DELETE_CANCELLED_TRAINING',
  ...
  RolePermission(
    'RELEASE_MATCH_FAMILY',
    'Spiel für Eltern und Spieler freigeben',
    PermissionKind.edit,
  ),
  RolePermission(
    'SEND_EVENT_NOTIFICATIONS',
    'Terminbenachrichtigungen versenden',
    PermissionKind.edit,
  ),
